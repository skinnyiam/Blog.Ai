    ...
    <div>
      ...
      <div className="p-4 flex flex-wrap gap-7">
        {travelPosts?.map((post: any) => {
          return (
            <>
              <Card post={post} imageHeight="h-96" />
            </>
          );
        })}
      </div>
